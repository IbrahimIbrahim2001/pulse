export default function AnimatedLogo({ width = 100, height = 100 }) {
    return (
        <svg width={width} height={height} viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
            <style>
                {`
      .pulse-ring-1 { animation: pulse-wave 2s ease-in-out infinite; }
      .pulse-ring-2 { animation: pulse-wave 2s ease-in-out infinite 0.5s; }
      ...
      `}
            ...
            <circle cx="50" cy="50" r="45" fill="none" stroke="oklch(0.7227 0.1920 149.5793)" strokeWidth="2" className="pulse-ring-1" />
            <circle cx="50" cy="50" r="35" fill="none" stroke="oklch(0.7227 0.1920 149.5793)" strokeWidth="3" className="pulse-ring-2" />
